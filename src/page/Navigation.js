...
const Navigation = (props) => {
    ...
    return (
        <Fragment>
            <nav className={`navbar navbar-expand navbar-white navbar-light transition-all  ${showfull ? "ml-0  border-b-2 z-1034" : "ml-60  border-b-2 z-1034"}   ${props.hidden === true ? 'hidden' : ''}  `} >
