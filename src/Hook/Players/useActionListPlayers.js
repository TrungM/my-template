...
const useActionListPlayers = (api) => {
    ...
    const { GetApiDelete } = useActionDelete("/api/players")
    ...
    const handleDeletePlayers = async (id) => {
...
export default useActionListPlayers;